...
class GroupEntityTest : ShouldSpec({
    ...
    should("map correct GroupEntity to Group") {
        ...
        groupEntity.also {
            ...
            it.baseCurrency shouldBe group.baseCurrency.map { currency -> CurrencyEntity(currency.code) }
    ...
    should("map correct Group to GroupEntity") {
        ...
        group.also {
            ...
            it.baseCurrency shouldBe groupEntity.baseCurrency.map { currencyEntity -> Currency(currencyEntity.code) }
